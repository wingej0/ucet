...
::::: columns
::: {.column width="50%"}
![](img/attendance.jpg) ![](img/contact.png)
:::

::: {.column width="50%"}
![](https://acadiencelearning.org/wp-content/themes/divi-child/images/logo.svg) ![](img/toscrf.jpg) ![](img/ckla.jpeg)
:::
:::::
...
-   The structure isn't flexible
-   It's Microsoft ![](img/linux.png){.absolute bottom="0" right="0" width="300" height="300"}
:::
:::::
:::::::
